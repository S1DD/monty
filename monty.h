...
/* Stack operations */
stack_t *monty_create_node(int n);
void monty_free_nodes(void);
void monty_display_stack(stack_t **, unsigned int);
void monty_push_element(stack_t **, unsigned int);
void enqueue(stack_t **, unsigned int);

void execute_func(op_func, char *, char *, int, int);

void monty_pint(stack_t **, unsigned int);
void monty_pop_top_node(stack_t **, unsigned int);
void monty_nop(stack_t **, unsigned int);
void monty_swap_nodes(stack_t **, unsigned int);
